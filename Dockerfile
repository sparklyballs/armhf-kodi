...
libmad-dev libmicrohttpd-dev libmodplug-dev libmpeg2-dev libnfs-dev libogg-dev \
libplist-dev libpng-dev libsamplerate-dev libshairport-dev libssh-dev libtool \
libva-dev libvorbis-dev libxmu-dev libxrandr-dev libxslt-dev libxt-dev lzo-dev \
...
./configure --build=$CBUILD --disable-airplay --disable-airtunes --disable-alsa \
--disable-asap-codec --disable-avahi --disable-dbus --disable-debug --disable-dvdcss \
--disable-goom --disable-joystick --disable-libcap --disable-libcec --disable-libusb \
...
--disable-vaapi --disable-vdpau --disable-vtbdecoder --disable-waveform \
--enable-libbluray --enable-nfs --enable-ssh --enable-static=no --enable-upnp \
--host=$CHOST --infodir=/usr/share/info --localstatedir=/var --mandir=/usr/share/man \
--prefix=/usr --sysconfdir=/etc --with-ffmpeg=shared && \
